...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("insights", "Show usage insights and analytics", "Info",
               args_hint="[days]"),
    CommandDef("logs", "Show Hermes logs with filtering", "Info",
               args_hint="[--all|--errors|--autonomy] [--filter text] [--level lvl] [--since N] [--limit N]"),
    ...
    CommandDef("update", "Update Hermes Agent to the latest version", "Info",
               gateway_only=True),
    CommandDef("coord", "Coordinator mode — async multi-agent tasks", "Autonomy",
               gateway_only=True,
               args_hint="[task | status | cancel | history | score | watch [N] | parallel <task>]",
               subcommands=("status", "cancel", "history", "score", "watch", "parallel")),
    CommandDef("research", "Research hub — multi-engine search & recall", "Autonomy",
               gateway_only=True,
               args_hint="[query | recall <query> | save <topic> | <content> | topics]",
               subcommands=("recall", "save", "topics")),
    CommandDef("research-recall", "Search saved research findings", "Autonomy",
               gateway_only=True, args_hint="<query>"),
    CommandDef("research-save", "Save a research finding", "Autonomy",
               gateway_only=True, args_hint="<topic> | <content>"),
    CommandDef("research-topics", "List saved research topics", "Autonomy",
               gateway_only=True),
